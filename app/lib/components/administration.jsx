...
export default class sysinfoComponent extends React.Component {
    ...
    constructor( props ) {
        ...
        this.state.RunningBlockIsEdit = false;
        ...
        this.state.runModeList = [
            { payload: 'Home Controller', text: __( 'Home Controller' ) },
            { payload: 'Local Controller', text: __( 'Local Controller' ) },
        ];
        ...
        this.state.ip = this.props.boardInfo.system[Object.keys( this.props.boardInfo.system )[0]].ip;
        this.state.port = this.props.boardInfo.system[Object.keys( this.props.boardInfo.system )[0]].port;
